...
<section class="section bg-howitworks" id="section_find">
    <div class="container">
        ...
        <?php
            ...
            $q="select *,AVG(ratingNumber) avg from gyms g inner join item_rating r on r.gym_id=g.gym_id GROUP BY g.gym_id order by avg desc LIMIT $offset, $total_records_per_page";
