...
<body>
	<section>
		...
		<ul class="navigation">
		<?php
		$res = mysqli_query($con, "SELECT * FROM prime_videos");
		while ($row = mysqli_fetch_array($res)) {
			?>
			<li onclick="videourl('videos/video_and_img/<?php echo $row['video_name'];?>')"><img src="videos/video_and_img/<?php echo $row['image']; ?>"></li>
			<?php
		}
		?>
		</ul>
