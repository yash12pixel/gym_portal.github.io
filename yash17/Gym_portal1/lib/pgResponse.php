...
<div class="card-body">
      ...
      <table class="table table-bordered table-striped table-hover table-responsive-lg " width="100%" cellspacing="0" style="background-color: white;">
          ...
          <center>
              <a href="../index.php?prime=true" class="btn btn-primary" >Done</a>
          </center>
        ...
        $mail->Password = 'TonyStark0880';                // SMTP password
     ...
     <tr style='border-collapse:collapse;'> 
      <td valign='top' style='padding:0;Margin:0;'> 
               ...
               <table width='100%' cellspacing='0' cellpadding='0' style='mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;'> 
                 <tr style='border-collapse:collapse;'> 
                  <td width='580' valign='top' align='center' style='padding:0;Margin:0;'> 
                   <table width='100%' cellspacing='0' cellpadding='0' role='presentation' style='mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;'> 
                     <tr style='border-collapse:collapse;'> 
                      <td align='center' style='Margin:0;padding-left:10px;padding-right:10px;padding-top:25px;padding-bottom:25px;'></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
       ...
       <table class='es-content' cellspacing='0' cellpadding='0' align='center' style='mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%;'> 
                 ...
                 <tr style='border-collapse:collapse;'> 
                  <td width='600' valign='top' align='center' style='padding:0;Margin:0;'> 
                   <table style='mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;border-radius:4px;background-color:#FFFFFF;' width='100%' cellspacing='0' cellpadding='0' bgcolor='#ffffff' role='presentation'> 
                     <tr style='border-collapse:collapse;'> 
                      <td class='es-m-txt-l' bgcolor='#ffffff' align='left' style='Margin:0;padding-top:20px;padding-bottom:20px;padding-left:30px;padding-right:30px;'><p style='Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:18px;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;'>Dear <b>".$fname." ".$lname.",</b><br>You have successfully purchased Prime  Membership of <b>GYM PORTAL.</b> on date<b>$trans_date</b>, Your transaction id is <b>$trans_id</b> and amount is <b>$trans_amt</b></p><br/><p>Now you can watch prime videos as well as have access to different diet charts, your prime membership will expire on date : <b>$membership_end_date</b></b></p></td> 
                     </tr>   
                     <tr style='border-collapse:collapse;'> 
		...
		echo "<center><b>Transaction status is failure</b>" . "<br/><a href='../index.php?prime=false' class='btn btn-primary' >Back</a></ceneter>";
	}
